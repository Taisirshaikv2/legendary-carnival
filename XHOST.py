...
# --- Configuration ---
TOKEN = '8056971478:AAHqGzpBrlyL5yWF6BFMrWSQps_uKn5o3TY'
OWNER_ID = 706483179
ADMIN_ID = 706483179
YOUR_USERNAME = '@aiojames'
UPDATE_CHANNEL = 'https://t.me/+pvfoeLCc3Os1ZmU1'
...
# --- Main Execution ---
# Add this at the very end of XHOST.py, before the if __name__ == '__main__' block

# Railway deployment configuration
PORT = int(os.environ.get("PORT", 8080))

# Modify the keep_alive function to work with Railway
def run_flask():
    app.run(host='0.0.0.0', port=PORT)

# Update the main execution block at the very bottom
